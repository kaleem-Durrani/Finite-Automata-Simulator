...
HELP_LINES = [
    ...
    "Exercises:",
    "- Right-click empty canvas for",
    "  Open an exercise. Type a name",
    "  like even_as; examples/ and",
    "  the .fsx are assumed",
    "- The prompt sits in the right",
    "  column while you draw",
    "- Check grades your machine. If",
    "  it is wrong you are told the",
    "  shortest word that tells the",
    "  two apart, and that word is",
    "  run on your machine so you",
    "  can watch where it goes",
    "",
    "Panels:",
